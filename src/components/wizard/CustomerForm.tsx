...
import { User, Phone, MapPin, FileText, Hash } from 'lucide-react'
...
export default function CustomerForm({ quote, clients, onChange }: CustomerFormProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label className="text-xs font-medium text-gray-500 mb-1.5 block">טלפון</label>
        <div className="relative">
      ...
      <div>
        <label className="text-xs font-medium text-gray-500 mb-1.5 block">כתובת</label>
        <div className="relative">
